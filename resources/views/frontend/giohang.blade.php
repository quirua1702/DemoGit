				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
						<li class="breadcrumb-item">
							...
							<a href="{{ route('frontend.goidata') }}">Gói data</a>
							</li>
...
<h2 class="h6 text-light mb-0">Gói data trong giỏ</h2>
<a class="btn btn-outline-primary btn-sm ps-2" href="{{ route('frontend.goidata') }}">
...
<h3 class="fw-normal">{{ Cart::priceTotal() }}<small>đồng</small></h3>
